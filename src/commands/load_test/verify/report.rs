//! Aggregations applied at the end of a verification run: peak throughput
//! per pipeline step, the rolled-up `VerificationReport`, and the "stuck at
//! X" classification for txs that timed out.
